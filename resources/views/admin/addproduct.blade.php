                            ...
                            <div class="col mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('addproductsubmit')}}" id="addproductform" enctype="multipart/form-data" method="POST">
                                            {{ csrf_field() }}
                                                    ...
                                                    <div class="col-12 col-sm-auto mb-3">
                                                        <div class="mx-auto" style="width: 140px;">
                                                            <div class="d-flex justify-content-center align-items-center rounded" style="height: 140px; background-color: rgb(233, 236, 239);">
                                                                <img id="image_block" alt="no-image" style="width:160px;height:140px;border-radius:5px;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" minlength="4" type="text" name="name" placeholder="Enter Product Name" required >
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Product Price</label>
                                                                    <input class="form-control" type="number" name="price" placeholder="Enter product price" min="1" required >
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" required name="quant_step" placeholder="For Example : 0.25 => 250 grams">
                                                                </div>
                                                            </div>
                                                            <div class="col justify-content-center" >
                                                                ...
                                                                <button class="btn btn-success"  type="submit"><i class="fa fa-plus"></i> Add Product</button>
                                                                </div>
                                                                </div>
                                                            </div>
