        ...
        <!-- Begin Page Content -->
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between" style="padding-bottom:20px;">
                    <h1 class="h3 mb-0 text-gray-800">All Settings</h1>
                ...
                <div class="row">
                    <form action="" method="POST" style="width:100%;">
                        ...
                        <div class="row justify-content-center" style="padding:5px;">
                            <div class="form-group col-sm-3">
                                ...
                                <input type="text" class="form-control" required minlength="4" name="setname" placeholder="Enter Setting Name">
                            </div>
                            <div class="form-group col-sm-3">
                                <label>Setting Value</label>
                                <input type="number" class="form-control" name="setvalue" placeholder="Enter Setting Value" required min="0">
                            </div>
                            <div class="col-sm-3" style="padding-top: 30px;">
                                <button class="btn btn-success" disabled name="addsetting"><i class="fa fa-plus"></i> Add New Setting</button>
                            </div>
                    ...
                    <div class="col card shadow mb-4" style="padding:0px;">
                        ...
                        <div class="card-body">
                            @if($settings->isEmpty())
                                <h5 style="text-align:center;display:block;margin:20px;">No Setting is added yet.</h5>
                            @else
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        @foreach($settings as $s)
                                            <form action="{{route('updatesetting',$s->id)}}" method="POST">
                                                {{ csrf_field() }}
                                                <tr class="text-center">
                                                    <td>{{$s->id}}</td>
                                                    <td><input type="text" class="form-control" required minlength="4" name="updatesetname" value="{{$s->setting_name}}"></td>
                                                    <td><input type="number" class="form-control" required min="0" name="updatesetvalue" value="{{$s->setting_value}}"></td>

                                                    <td>
                                                        <attr title="Update Setting"><button class="btn btn-warning" type="submit"><i class="fa fa-pencil"></i> Update</button></attr>
                                                    </td>
                                                </tr>
                                            </form>
                                        @endforeach
